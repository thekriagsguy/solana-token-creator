...
import { TiSocialTwitter, TiSocialGithub, TiSocialLinkedin, TiSocialYoutube} from "react-icons/ti";
                ...
                menuOne.map((item, index) => (
                  <li>
                    <a href="#" className="text-default-300 text-base transition-all hover:text-white">
                      <i data-lucide="me-2 inline-block h-4 w-4">
                      {item}
                      </i>
                    </a>
                  </li>
             ...
             <div className="p-10">
              ...
              <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                ...
                <div className="relative">
                  ...
                  <button type="submit" disabled={state.submitting} className="haver:bg-primary-hover hover:border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounded-md px-6 text-white transition-all">Subscribe</button>
                </div>
              </form>
              ...
              <div>
                ...
                <ul className="flex flex-wrap items-center gap-1">
                  {[
                    ...
                    <li key={index}>
                      <a href="#" className="hover:bg-primary group inline-flex h-10 w-10 items-center justify-center tounded-lg border border-white/10 transition-all duration-500">
                       <i data-lucide="twitter" className="text-default-300 group-hover:text-white">
                        {social}
                       </i>
                      </a>
                    </li>
